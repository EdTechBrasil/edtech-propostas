...
console.log('Migration 016: Corrigindo tipo_calculo dos livros MPC...')

const { data, error } = await supabase
  .from('produto_componentes')
  .update({ tipo_calculo: 'PorAlunoXTema' })
  .in('nome', ['Livro Ilustrado', 'Livro de Desafios', 'Livro de Atividades'])
